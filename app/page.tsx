...
export default async function LoginPage({
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-x-hidden bg-[hsl(201_100%_13%)] text-white lg:h-[100dvh] lg:overflow-hidden">
      ...
      <div className="relative z-10 mx-auto grid min-h-[100dvh] max-w-7xl items-start gap-7 px-5 py-8 sm:px-8 md:py-10 lg:h-full lg:min-h-0 lg:grid-cols-[minmax(0,1fr)_430px] lg:gap-6 lg:px-8 lg:py-5">
        <section className="mx-auto max-w-4xl pt-16 text-center sm:pt-20 lg:mx-0 lg:pt-[12vh] lg:text-left xl:pt-[15vh]">
          ...
          <div className="animate-fade-rise max-w-4xl">
            <h1
              className="font-display text-[2.9rem] font-normal leading-[0.95] tracking-[-1.4px] text-white sm:text-6xl md:text-7xl lg:tracking-[-2.46px] xl:text-[5.8rem]"
          ...
          <p className="animate-fade-rise-delay mx-auto mt-5 max-w-2xl text-base leading-relaxed text-white/72 sm:text-lg lg:mx-0 lg:text-white/66">
        ...
        <div className="animate-fade-rise-delay-2 flex justify-center pb-8 lg:justify-end lg:pb-0">
